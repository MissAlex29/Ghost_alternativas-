...
function setup() {
  ...
  //Bloques laterale spara NO salir 
  invisibleBlock1 = createSprite(80,300,10,600);
  invisibleBlock2 = createSprite(520,300,10,600);
...
function draw() {
  ...
  if(gameState === "play"){
        ...
        //CONDICIÓN PARA NO SALIR DE LOS BORDES 
        if(invisibleBlock1.isTouching(ghost)|| invisibleBlock2.isTouching(ghost)){
